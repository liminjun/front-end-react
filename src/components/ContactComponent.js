                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text id="lastName" name="lastName" placeholder="Last Name" model=".lastName" className="form-control"
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" type="tel" id="telnum" name="telnum" placeholder="Tel No." className="form-control"
                                        validators={{ required, minLength: minLength(3), maxLength: maxLength(15),isNumber }}></Control.text>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text type="tel" id="email" name="email" placeholder="mail@example.com" model=".email" className="form-control"
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={{ size: 6, offset: 2 }}>
                                    <div className="form-check">
                                        <Label check>
                                            <Control.checkbox name="agree" model=".agree" className="form-check-input" />{' '}
